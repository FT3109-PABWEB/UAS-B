...
<div class="row">
    ...
    elseif ($_GET['alert'] == 4) { ?>
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong><i class="fas fa-times-circle"></i> Gagal!</strong> NIS <b><?php echo $_GET['nis']; ?></b>
            sudah ada.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
    ...
    ?>
        <form  class="mr-3" action="index2.php" method="post">
            <div class="form-row">
                <!-- form cari -->
                <div class="col-3">
        ...
        <table class="table table-striped table-bordered" style="margin-top: 20px;" >
            ...
            if (isset($cari)) {
            // perintah query untuk menampilkan jumlah data siswa dari database berdasarkan nis atau namanyang sesuai dengan kata kunci pencarian
    ...
    while ($data = mysqli_fetch_assoc($query)) { ?>
        ...
        <tr>
            ...
            <td width="120" class="center">
                ...
                <a title="Hapus" class="btn btn-outline-danger" href="hapus.php?nis=<?php echo $data['nis'];?>" onclick="return confirm('Anda yakin ingin menghapus siswa <?php echo $data['nama']; ?>?');"><i class="fas fa-trash"></i></a>
            </td>
        </tr>
    <?php
        $no++;
