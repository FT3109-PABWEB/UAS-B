	...
	?>
        <div class="container-fluid">
            <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-blue border-bottom shadow-sm">
                <h6 class="my-0 mr-md-auto font-weight-normal"><i class="fas fa-user title-icon"></i> Data
            Siswa</h6>
            <h6 class="my-0 mr-lf-auto font-weight-normal"><a href="logout.php" style="color: white;"><i class="fas fa-sign-out-alt white" ></i> Logout</h6></a>
            </div>
        </div>
