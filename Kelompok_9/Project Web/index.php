...
Bootstrap 4"><meta name="author" content="yysofiyan">

<!-- favicon -->
<link rel="shortcut icon" href="asset/img/favicon.png">
<!-- Bootstrap CSS -->
<link rel="stylesheet" type="text/css" href="asset/plugins/bootstrap-4.1.3/css/bootstrap.min.css">
<!-- datepicker CSS -->
<link rel="stylesheet" type="text/css" href="asset/plugins/datepicker/css/datepicker.min.css">
<!-- Font Awesome CSS -->
<link rel="stylesheet" type="text/css" href="asset/plugins/fontawesome-free-5.4.1-web/css/
all.min.css">
<!-- Custom CSS -->
...
<h5 class="my-0 mr-md-auto font-weight-normal"><i class="fas fa-user title-icon"></i> Data Buku
</h5>
</div>
</div>
...
&copy; 2021 - <a class="text-info" href="https://stmik-sumedang.ac.id/">Kelompok 9</a>
</div>
</div>
</footer>
</div>
...
<script type="text/javascript" src="asset/plugins/bootstrap-4.1.3/js/bootstrap.min.js"></script>
<!-- fontawesome js -->
<script type="text/javascript" src="asset/plugins/fontawesome-free-5.4.1-web/js/
all.min.js"></script>
<!-- datepicker js -->
